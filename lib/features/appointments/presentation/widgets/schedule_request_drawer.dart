...
class ScheduleRequestDrawer extends StatefulWidget {
  ...
  static void show(BuildContext context, AppointmentRequestEntity request) {
    showGeneralDialog(
      context: context,
      barrierDismissible: true,
      barrierLabel: 'Schedule Request',
  ...
  @override
  State<ScheduleRequestDrawer> createState() => _ScheduleRequestDrawerState();
}

class _ScheduleRequestDrawerState extends State<ScheduleRequestDrawer> {
  ...
  Future<void> _submit() async {
    if (_selectedStart == null) {
      AppUtils.showSnackBar(
        context: context,
        extraMessage: 'Please select an appointment time.',
                ...
                child: Column(
                  ...
                  children: [
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                child: Text(
                                  'PREFERENCE: ${widget.request.preferredDisplay}',
                    ...
                    if (availableSlots.isNotEmpty) ...[
                      _buildLabel('RECOMMENDED AVAILABLE SLOTS (1-CLICK PICK)', isDark),
                      const SizedBox(height: 8),
                      Wrap(
                        spacing: 8,
                        runSpacing: 8,
                    ...
                    // Selected Date & Time Picker trigger
                    _buildLabel('CONFIRMED MEETING TIME *', isDark),
                    const SizedBox(height: 6),
                    InkWell(
                      onTap: _pickDateTime,
                      borderRadius: BorderRadius.circular(8),
                    ...
                    if (_meetingType == 'in_person') ...[
                      _buildLabel('LOCATION / ADDRESS', isDark),
                      const SizedBox(height: 6),
                      AppTextFieldWidget(
