...
class CustomersHeaders extends StatefulWidget {
  ...
  @override
  State<CustomersHeaders> createState() => _CustomersHeadersState();
}

class _CustomersHeadersState extends State<CustomersHeaders> {
  ...
  final List<String> _statuses = const ['All', 'Active', 'Deactive'];
